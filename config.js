...
module.exports = {
    ...
    BOT_NAME: "ECHO-MD Mini",
    BOT_FOOTER: '© 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝙴𝙲𝙷𝙾-𝙼𝙳',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/Iy8vxlb2F1iJjeQaXjMLXN?s=cl&p=a&mlu=2&amv=0',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://files.catbox.moe/vln5sk.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb86btmI1rci3S1NUA0G',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '7214172448:AAHGqSgaw-zGVPZWvl8msDOVDhln-9kExas',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '+2348108585216'
